	...
	var Easycal = {
		...
		renderSlotHTML : function(scheduleList){
			...
			if(scheduleList.length > 1){
				...
				var availabilityData = JSON.parse(schedule.id);
				var beginTime = availabilityData.time;
				console.log(beginTime);
				var availabilityId = availabilityData.availability_id;
				var href = '/appointments/new?';
				href += 'availability_id=' + availabilityId + '&';
				href += 'begins_at=' + beginTime;
				html += '' +
					'<a href="' + href + '" style="padding-top: 4px;">' +
